...
+ (CAGradientLayer *)getColorLayer {
    CAGradientLayer * layer = [[CAGradientLayer alloc] init];
    layer.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [AppDelegate navigationHeight]);
    layer.colors = @[(id)[UIColor colorWithCSS:@"ffaad5"].CGColor, (id)[UIColor colorWithCSS:@"4dffff"].CGColor];
    return layer;
}
